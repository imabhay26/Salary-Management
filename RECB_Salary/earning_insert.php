...
ini_set( "display_errors", 0); 
		...
		if($refno=='' ||$date==''|| $pipb==''||$sp==''||$arr==''||$othr==''||$joining==''||$designation==''||$da_per==''||$cca==''||$hra==''||$bonus==''||$absent==''){
		...
		else
		{
			...
			$sql = "INSERT INTO salary (refno ,date, pipb , da_per , sp , arr , othr , joining , designation , cca , hra , bonus , absent , total_days , deduction , da,gross) 
			VALUES ( '$refno' , '$date' , '$pipb' , '$da_per' , '$sp' , '$arr' , '$othr' , '$joining' , '$designation' , '$cca' , '$hra' , '$bonus' , '$absent' , '$total_days' , '$deduction' ,'$da','$gross' ) ";
...
<head>
    <meta charset="UTF-8">
    <title>Earning Panel Insert</title>
...
<div class="container page">
    <div class="card border border-primary mt-3 ml-5 mr-5">
        <div class="card-header text-center bg-primary text-white font-weight-bold">
            <div class="row">
                ...
                <div class="col-8">
					...
					<h6 class="font-weight-bold">(PAY ROLL - EARNINGS : INSERT)</h4></h2>
                </div>
                <div class="col-2">
        ...
        <div class="card-body">
            <div class="row pb-3">
                ...
                <div class="col-4">
                    <a href="earning_insert.php" style="text-decoration:none">
                        <button class="btn btn-outline-danger btn-block" id="in">INSERT DETAILS</button>
                    </a>
                </div>
                <div class="col-4">
                    <a href="earning_update.php" style="text-decoration:none">
                        <button class="btn btn-outline-danger btn-block" id="up">UPDATE DETAILS</button>
                    </a>
                </div>
                <div class="col-2">
			...
			<form name="frmRegistration" method="POST" action=""name="vform" id="muForm">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <button class="btn btn-primary btn-block" onclick="func()" type="submit" name="register-user" value="submit" id="submit" type="button ">Submit</button>
                    </div>
                    <div class="col-5">
        ...
        <div class="card-footer bg-danger text-center text-white">
            <h6>To visit Deduct Insert Page<a href="deduct_insert.php" style="text-decoration:none;color:yellow">&nbsp;Click Here</a></h6>
        </div>
    </div>
</div>
<div id="loading"></div>
